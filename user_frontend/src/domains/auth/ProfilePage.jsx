...
export default function ProfilePage() {
  ...
  const uploadedStandardCount = STANDARD_DOC_TYPES.filter((std) =>
    evidenceList.some((e) => e.certificateType === std.key)
  ).length;
  ...
  return (
    <div className={`${styles.page} animate-fade-in`}>
      ...
      <Card>
        ...
        {/* Progress Tracker */}
        {familyId && (
          <div className={styles.lockerProgressBox}>
            <div className={styles.progressBarBg}>
              <div className={styles.progressBarFill} style={{ width: `${progressPercent}%` }} />
            </div>
            <span className={styles.lockerProgressText}>
              {uploadedStandardCount} of {STANDARD_DOC_TYPES.length} Standard Documents Ready ({progressPercent}%)
            </span>
          </div>
        )}
        ...
        {!familyId ? (
          ...
          <div className={styles.docGrid}>
            {STANDARD_DOC_TYPES.map((std) => {
              const uploadedDoc = evidenceList.find((e) => e.certificateType === std.key);
